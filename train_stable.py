...
class Train:
    ...
    #=============== STABLE train classifier (single-threaded) ===============
    ...
    def train_classifier(self):
        ...
        try:
            # Process images one by one (stable, no threading issues)
            for image_path in image_files:
                try:
                    ...
                    status_label.config(text=f"Students: {len(embeddings_dict)} | Skipped: {skipped}")
